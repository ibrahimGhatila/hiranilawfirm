...
const copy = {
  en: {
    ...
    sections: [
      ...
      ['How We Use Your Information', <><p>We use information to respond to consultation requests, communicate with you, operate and secure the website, understand website usage when analytics consent is granted, measure advertising performance and personalize advertising when advertising consent is granted, improve our services, and comply with legal obligations.</p><p>We do not sell personal information.</p></>],
      ...
      ['Cookies, Analytics, and Advertising', <><p>Essential browser storage remembers your language and privacy choices. It is necessary for the requested site preferences and cannot be disabled through our banner.</p><p>Google analytics and advertising technologies are optional. Analytics may set cookies such as <code>_ga</code> for up to two years. Advertising storage, user-data processing, and ad personalization remain denied unless you enable Advertising. You may accept, reject, or customize each category and withdraw consent at any time through <strong>Cookie Settings</strong> in the footer.</p></>],
  ...
  es: {
    ...
    sections: [
      ...
      ['Cómo utilizamos su información', <><p>Utilizamos la información para responder consultas, comunicarnos con usted, operar y proteger el sitio, comprender su uso cuando existe consentimiento de analíticas, medir el rendimiento publicitario y personalizar anuncios cuando existe consentimiento de publicidad, mejorar nuestros servicios y cumplir obligaciones legales.</p><p>No vendemos información personal.</p></>],
      ...
      ['Cookies, analíticas y publicidad', <><p>El almacenamiento esencial del navegador recuerda sus preferencias de idioma y privacidad. Es necesario para esas funciones y no puede desactivarse desde el aviso.</p><p>Las tecnologías de analíticas y publicidad de Google son opcionales. Las analíticas pueden establecer cookies como <code>_ga</code> hasta por dos años. El almacenamiento publicitario, el tratamiento de datos de usuario y la personalización de anuncios permanecen denegados salvo que active Publicidad. Puede personalizar cada categoría y retirar el consentimiento mediante <strong>Configuración de cookies</strong>.</p></>],
      ...
      ['Servicios de terceros', <ul><li>Google Analytics / Google tag — analíticas, medición publicitaria o personalización opcionales según sus elecciones; consulte la <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer">Política de Privacidad de Google</a>.</li><li>Resend — entrega de formularios por correo; consulte la <a href="https://resend.com/legal/privacy-policy" target="_blank" rel="noreferrer">Política de Privacidad de Resend</a>.</li><li>Vercel — alojamiento y procesamiento de solicitudes; consulte la <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noreferrer">Política de Privacidad de Vercel</a>.</li></ul>],
