...
// Sender + recipients are hardcoded (server-side). The API key comes from the
// environment (RESEND_API_KEY) — set on Vercel and in .env.local for local dev.
const FROM = 'Hirani Law Firm <noreply@hiranilawfirm.com>'
const RECIPIENTS = [
